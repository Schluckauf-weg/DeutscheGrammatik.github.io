...
|                   |            |                         |                  |                    |
| senden            | sendet     | sandte [zantə]/sendete  | gesandt/gesendet | 送；邮寄；广播     |
| wenden            | wendet     | wandte [ˈvantə]/wendete | gewandt/gewendet | 翻转；转变         |
| verwenden         | verwendet  | verwandte               | verwandt         | 应用，利用         |
|                   |            |                         |                  |                    |
...
|           |                |         |             |                  |
| gebären   | gebärt/gebiert | gebar   | geboren     | 分娩；产生       |
