...
|   连词    |     介词     |       副词       |      |
| :-------: | :----------: | :--------------: | :--: |
|  während  |   während    |  währenddessen   |      |
|   bevor   |     vor      |   davor/zuvor    |      |
|  nachdem  |     nach     |      danach      |      |
|   seit    |     seit     |     seitdem      |      |
|  obwohl   |    trotz     |     trotzdem     |      |
| (an)statt |  (an)statt   |   stattdessen    |      |
|   weil    |    wegen     | deswegen/deshalb |      |
| als/wenn  |     bei      |        da        |      |
|   damit   |    zu/für    |      um zu       | 目的 |
|   indem   | dadurch dass |      durch       | 方式 |
